...
public class TileManager extends Tile{
    ...
    public void getTileImage(){
        try{
            ...
            map=ImageIO.read(getClass().getResourceAsStream("/maps/map1.png"));
            ...
            tile[33].image=terrainSheet.getSubimage(528,208,16,16);
            tile[34].image=terrainSheet.getSubimage(544,240,16,16);
            tile[35].image=terrainSheet.getSubimage(528,224,16,16);
            tile[36].image=terrainSheet.getSubimage(528,272,16,16);
            tile[37].image=terrainSheet.getSubimage(320,208,16,16);
    ...
    public void draw1(Graphics2D g2){
        ...
        g2.drawString("x: "+gp.player.x+ " y: "+gp.player.y,10,50);
    }
